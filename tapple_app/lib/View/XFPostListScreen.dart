...
class _XFPostListScreenState extends State<XFPostListScreen> {
  ...
  void postNewReply(message) async {
    await postReply(widget.parentThread.thread_id, message).then((int statusCode){
      getPostList(widget.parentThread.thread_id,data.pagination.last_page);
      if(statusCode == 200) {
                        ...
                        for(var item in paginationList ) Container(
                          ...
                          child: FlatButton(
                            onPressed: data.pagination.current_page == item + 1 ? () {
                              ...
                              getPostList(widget.parentThread.thread_id, item + 1);
                            ...
                            Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border(
                                  ...
                                  top: BorderSide(color: Color(0xFFFFDFDFDF), width: 0.5),
                                  bottom: BorderSide(color: Color(0xFFFFDFDFDF), width: 0.5),
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  maxLines: 8,
                                  decoration: InputDecoration.collapsed(hintText: "Write your reply..."),
                                ),
                              ),
                            ),
                            RaisedButton(
                              onPressed: _replyController.text.trim() == "" || _replyController.text.trim() == null ? null : () {
                                setState(() {
                                  data = null;
                                });
                                reactToStatusCode();
                          ...
                          children: <Widget>[
                            for(var item in paginationList ) Container(
                              ...
                              child: FlatButton(
                                ...
                                color: data.pagination.current_page == item + 1 ? Colors.red : Colors.grey,
                              ),
                            ),
                          ],
                        ),
